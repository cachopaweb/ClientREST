...
type
    ...
    function Request: TObject;
    function Response: TObject;
	end;
...
begin
    ...
    Result.Route      := FRestClient.BaseURL;
	except
		on E: Exception do
		begin
			Result.Content    := FRestResponse.Content;
...
function TClientREST.Request: TObject;
begin
	Result := FRestRequest;
end;

function TClientREST.Response: TObject;
begin
